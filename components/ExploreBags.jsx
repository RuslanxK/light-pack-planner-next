...
const ExploreBags = ({ exploreBags }) => {
  ...
  useEffect(() => {
    const getWeightOptions = () => {
      switch (weightUnitFilter) {
        case 'kg':
          return ['0-5', '5-10', '10-15', '15+'];
        case 'lb':
          return ['0-10', '10-20', '20-30', '30+'];
        case 'g':
          return ['0-5000', '5000-10000', '10000-15000', '15000+'];
        case 'oz':
          return ['0-175', '175-350', '350-525', '525+'];
        default:
          return ['Select weight unit'];
      }
    };
    setWeightOptions(getWeightOptions());
    setWeightFilter('');
  }, [weightUnitFilter]);
    ...
    <Container sx={{ display: theme.flexBox }} maxWidth={false} disableGutters>
      <Stack display={theme.flexBox} justifyContent={theme.start} width={theme.trips.width} minHeight="100vh" pb={5}>
        <div className="main-info">
          ...
          <Stack>
          <Stack direction="row" justifyContent="space-between" alignItems="center" flexWrap="wrap" mb={2} backgroundColor={theme.main.darkColor} p={2} >
            <TextField
