...
const SharedItem = (props) => {
  ...
  return (
    ...
    <div className="scroll-div">
      ...
      <Select size='small' variant='outlined' disabled name='priority' sx={{width: '15%', fontSize: "12px",  marginRight: "10px", marginLeft: "15px", backgroundColor: getBackgroundColor(props.itemData.priority)}} value={props.itemData.priority}>  
