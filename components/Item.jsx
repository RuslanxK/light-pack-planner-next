...
const Item = (props) => {
  ...
  return (
    ...
    <div className="scroll-div" sx={{ overflowX: "scroll"}}  ref={setNodeRef} style={style}>
      ...
      <Stack mb={0.5} flexDirection="row" justifyContent={theme.between} alignItems={theme.end} onMouseOver={() => setItemHover(true)}  backgroundColor={ theme.palette.mode === "dark" ? '#2e2d2d' : "#dbdbdb" } onMouseLeave={() => setItemHover(false)} >
